...
<body>
  @include('attendance::partials.profile_image_modal')
                ...
                <div class="sidebar">
                  ...
                  <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                      ...
                      <li class="nav-item">
                        <a href="{{route('user.mark_attendance')}}" class="nav-link">
                      ...
                      <li class="nav-item menu-is-opening menu-open">
                        ...
                        <ul class="nav nav-treeview" style="display: block;">
                          <li class="nav-item">
                            <a href="{{route('leave-apply')}}" class="nav-link">
                          ...
                          <li class="nav-item">
                            <a href="{{route('leave-balance')}}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Leave Balance</p>
                            </a>
                          </li>
                      ...
                      <!-- <li class="nav-item menu-is-opening menu-open">
                        ...
                        <ul class="nav nav-treeview" style="display: block;">
                          <li class="nav-item">
                            <a href="{{--route('allowed-leaves')--}}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Allowed Leaves</p>
                            </a>
                          </li>
                          ...
                          <li class="nav-item">
                            <a href="{{--route('availed leaves')--}}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>Availed Leaves</p>
                            </a>
                          </li>
                          ...
                          <li class="nav-item">
                            <a href="{{--route('remaining-leaves')--}}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                      ...
                      <li class="nav-item">
                        <a href="{{route('attendance-correction-request')}}" class="nav-link">
                          <i class="nav-icon fas fa-tachometer-alt"></i>
                          <p>
                            Correction Request
                          </p>
    ...
    <!-- AdminLTE -->
    <script src="{{ asset('uzair3/attendance/adminlte/dist/js/adminlte.js') }}"></script>
